...
RUN ln -snf /usr/share/zoneinfo/$TZ /etc/localtime && echo $TZ > /etc/timezone && \
    ...
    apt-get -y install vim zip unzip curl wget git imagemagick pngquant gpsbabel parallel proj-bin inkscape netcat\
               php php-cli php-gd php-xml php-curl php-json php-mbstring php-zip  && \
